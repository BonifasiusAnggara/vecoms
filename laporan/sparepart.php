...
<html>
<head>
	<title>Laporan Jenis Sparepart</title>
			...
			<tr>
				...
				<td>
					...
					<table>
						...
						<?php
							$id_bkl = $r['id_bkl'];
							$srv = mysqli_query($conn, "SELECT * FROM sparepart, bengkel WHERE sparepart.id_bkl=bengkel.id_bkl AND sparepart.id_bkl='$id_bkl'");
							while ($sv = mysqli_fetch_array($srv)) { ?>
						<tr>
							<td><?php echo $sv['nama_sprt']?></td>
							<td align="right"><?php echo format_rupiah($sv['harga_sprt']); ?></td>
						</tr>
						<?php } ?>
					</table>
				</td>
