<?php
	...
	if ($_GET['module'] == 'tambah') {
		...
		$filter = $km-$km_awal;
		if ($nama_serv == "Service Mesin") {
			if ($filter < 4900) {
				echo "<script>
			  		alert('Selisih kilometer untuk Service Mesin mobil ini belum mencapai 700 !!');
		...
		} elseif ($nama_serv == "Ganti Oli") {
			if ($filter < 4900) {
				echo "<script>
					alert('Selisih kilometer untuk Ganti Oli mobil ini belum mencapai 700 !!');
					window.location.href='../media.php?module=service_mobil&&act=input_service&&kode_svc=$kode_svc&&id_mobil=$id_mobil';
				  </script>";
			} else {
				$query = mysqli_query($conn, "INSERT INTO detail_service (kode_svc, id_mobil, km, id_serv, nama_serv, harga_serv, tax) VALUES ('$kode_svc','$id_mobil','$km','$id_serv','$nama_serv','$harga_serv','$tax')");
		...
		} elseif ($nama_serv == "Ganti Oli Gardan") {
			if ($filter < 1000) {
				echo "<script>
					alert('Selisih kilometer untuk Ganti Oli Gardan mobil ini belum mencapai 1000 !!');
					window.location.href='../media.php?module=service_mobil&&act=input_service&&kode_svc=$kode_svc&&id_mobil=$id_mobil';
				  </script>";
			} else {
				$query = mysqli_query($conn, "INSERT INTO detail_service (kode_svc, id_mobil, km, id_serv, nama_serv, harga_serv, tax) VALUES ('$kode_svc','$id_mobil','$km','$id_serv','$nama_serv','$harga_serv','$tax')");
		...
		} elseif ($nama_serv == "Spooring") {
			if ($filter < 1000) {
				echo "<script>
					alert('Selisih kilometer untuk Spooring mobil ini belum mencapai 1000 !!');
					window.location.href='../media.php?module=service_mobil&&act=input_service&&kode_svc=$kode_svc&&id_mobil=$id_mobil';
				  </script>";
			} else {
				$query = mysqli_query($conn, "INSERT INTO detail_service (kode_svc, id_mobil, km, id_serv, nama_serv, harga_serv, tax) VALUES ('$kode_svc','$id_mobil','$km','$id_serv','$nama_serv','$harga_serv','$tax')");
		...
		} elseif ($nama_serv == "Balancing") {
			if ($filter < 1000) {
				echo "<script>
					alert('Selisih kilometer untuk Balancing mobil ini belum mencapai 1000 !!');
					window.location.href='../media.php?module=service_mobil&&act=input_service&&kode_svc=$kode_svc&&id_mobil=$id_mobil';
				  </script>";
			} else {
				$query = mysqli_query($conn, "INSERT INTO detail_service (kode_svc, id_mobil, km, id_serv, nama_serv, harga_serv, tax) VALUES ('$kode_svc','$id_mobil','$km','$id_serv','$nama_serv','$harga_serv','$tax')");
		...
		} elseif ($nama_serv == "Stel Rem") {
			if ($filter < 1000) {
				echo "<script>
					alert('Selisih kilometer untuk Stel Rem mobil ini belum mencapai 1000 !!');
					window.location.href='../media.php?module=service_mobil&&act=input_service&&kode_svc=$kode_svc&&id_mobil=$id_mobil';
				  </script>";
			} else {
				$query = mysqli_query($conn, "INSERT INTO detail_service (kode_svc, id_mobil, km, id_serv, nama_serv, harga_serv, tax) VALUES ('$kode_svc','$id_mobil','$km','$id_serv','$nama_serv','$harga_serv','$tax')");
		...
		} elseif ($nama_serv == "Cover Clutch & Release") {
			if ($filter < 1000) {
				echo "<script>
					alert('Selisih kilometer untuk Cover Clutch & Release mobil ini belum mencapai 1000 !!');
					window.location.href='../media.php?module=service_mobil&&act=input_service&&kode_svc=$kode_svc&&id_mobil=$id_mobil';
				  </script>";
			} else {
				$query = mysqli_query($conn, "INSERT INTO detail_service (kode_svc, id_mobil, km, id_serv, nama_serv, harga_serv, tax) VALUES ('$kode_svc','$id_mobil','$km','$id_serv','$nama_serv','$harga_serv','$tax')");
		...
		} elseif ($nama_serv == "Tune Up") {
			if ($filter < 1000) {
				echo "<script>
					alert('Selisih kilometer untuk Tune Up mobil ini belum mencapai 1000 !!');
					window.location.href='../media.php?module=service_mobil&&act=input_service&&kode_svc=$kode_svc&&id_mobil=$id_mobil';
				  </script>";
			} else {
				$query = mysqli_query($conn, "INSERT INTO detail_service (kode_svc, id_mobil, km, id_serv, nama_serv, harga_serv, tax) VALUES ('$kode_svc','$id_mobil','$km','$id_serv','$nama_serv','$harga_serv','$tax')");
		...
		} elseif ($nama_serv == "Service Dinamo") {
			if ($filter < 1000) {
				echo "<script>
					alert('Selisih kilometer untuk Service Dinamo mobil ini belum mencapai 1000 !!');
					window.location.href='../media.php?module=service_mobil&&act=input_service&&kode_svc=$kode_svc&&id_mobil=$id_mobil';
				  </script>";
			} else {
				$query = mysqli_query($conn, "INSERT INTO detail_service (kode_svc, id_mobil, km, id_serv, nama_serv, harga_serv, tax) VALUES ('$kode_svc','$id_mobil','$km','$id_serv','$nama_serv','$harga_serv','$tax')");
		...
		} elseif ($nama_serv == "Service Mesin 2") {
			if ($filter < 1000) {
				echo "<script>
					alert('Selisih kilometer untuk Service Mesin 2 mobil ini belum mencapai 1000 !!');
					window.location.href='../media.php?module=service_mobil&&act=input_service&&kode_svc=$kode_svc&&id_mobil=$id_mobil';
				  </script>";
			} else {
				$query = mysqli_query($conn, "INSERT INTO detail_service (kode_svc, id_mobil, km, id_serv, nama_serv, harga_serv, tax) VALUES ('$kode_svc','$id_mobil','$km','$id_serv','$nama_serv','$harga_serv','$tax')");
		...
		} elseif ($nama_serv == "Salon Mesin") {
			if ($filter < 1000) {
				echo "<script>
					alert('Selisih kilometer untuk Salon Mesin mobil ini belum mencapai 1000 !!');
					window.location.href='../media.php?module=service_mobil&&act=input_service&&kode_svc=$kode_svc&&id_mobil=$id_mobil';
				  </script>";
			} else {
				$query = mysqli_query($conn, "INSERT INTO detail_service (kode_svc, id_mobil, km, id_serv, nama_serv, harga_serv, tax) VALUES ('$kode_svc','$id_mobil','$km','$id_serv','$nama_serv','$harga_serv','$tax')");
