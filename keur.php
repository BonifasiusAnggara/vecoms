...
require 'PHPMailerailer/PHPMailerailerAutoload.php';
...
$mail->addAddress('agung.irfani@enseval.com', 'Jajah Zahrudin');
$mail->addAddress('frengki.anggara@enseval.com', 'Didi Wulyanto');

//Set the subject line
$mail->Subject = 'KEUR ED Dekat';
...
$body = '<!DOCTYPE HTML>
					...
					<div style="font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
						...
						<p>Masa berlaku KEUR nya sudah mau habis, kurang '.$row[keur].' lagi.</p>
