...
<div class="hasil_cari">
	...
	<table class="table table-striped">
		...
		<?php
			...
			$query = mysqli_query($conn, "SELECT * FROM mobil, pegawai WHERE mobil.type_code=1 AND mobil.id_peg=pegawai.id_peg AND mobil.plat_no LIKE '%".$kode."%' OR mobil.type_code=1 AND mobil.id_peg=pegawai.id_peg AND pegawai.nama_peg LIKE '%".$kode."%'");
			$no = 1;
